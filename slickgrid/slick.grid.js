...
/* Edit - run globally accessible onRender() if defined */
if(Slick.Grid.onRender)Slick.Grid.onRender();
        }
        ...
        function absBox(elem) {
            ...
            while ((elem = elem.parentNode) != document.body && elem) { /* Edit - added elem test */
